...
@LogTransport({
  injects: [PrettyLoggerConfig],
})
export class PrettyLogTransform implements LogTransport {
  readonly NAME = 'pretty';

  constructor(private readonly config: ResolveConfig<typeof PrettyLoggerConfig>) {}
