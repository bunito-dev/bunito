...
export class ConfigService {
  ...
  getEnv(
    ...
    try {
      ...
      throw new InternalException(`Failed to process config ${key} env`, err);
    }
  }
  ...
  async getValue(
    ...
    try {
      ...
      throw new InternalException(`Failed to process config ${key} value`, err);
    }
  }
  ...
  async getSecret(
    ...
    try {
      ...
      throw new InternalException(`Failed to process config ${key} secret`, err);
    }
  }
