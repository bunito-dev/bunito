...
describe('HTTPRouter', () => {
  it('registers as a server router extension', () => {
    expect(getClassMetadata(HTTPBunServerRouter, 'provider')).toEqual({
  ...
  it('returns not found, not implemented, and automatic OPTIONS responses', async () => {
    ...
    const router = new HTTPBunServerRouter(
      {
  ...
  it('serializes handler errors and serializer failures', async () => {
    ...
    const serializedRouter = new HTTPBunServerRouter(
      {
        defaultResponseContentType: 'application/json',
      },
    ...
    const fallbackRouter = new HTTPBunServerRouter(
      {
        defaultResponseContentType: 'application/json',
      },
  ...
  it('rejects invalid middleware, unavailable middleware, duplicate routes, and empty controllers', () => {
    ...
    expect(
      () =>
        new HTTPBunServerRouter({ defaultResponseContentType: 'application/json' }, {
          locateComponents: () => ({
            moduleId,
            props: [
              {
