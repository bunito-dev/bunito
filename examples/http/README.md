...
| `json-middleware` | `4001` | JSON middleware, raw body injection, parsed body injection, and body validation | [`apps/json-middleware.http`](./apps/json-middleware.http) |
...
```text
apps/simple-controller/.env
apps/json-middleware/.env
apps/multiple-apis/.env
```

## What To Read

- `apps/simple-controller/src/foo.controller.ts`: route decorators and injections.
- `apps/json-middleware/src/foo.controller.ts`: `JSONMiddleware`, `Body()`, and
